                ...
                <tbody>
                    <?php
                        ...
                        if($result){
                            ...
                            ?>
                            <tr>
                                <td style="color:black"><?= $data['id_reclamation'] ?></td>
                                <td><?= $data['numero_chambre'] ?></td>
                                <td><?= $data['type'] ?></td>
                                <td><?= $data['etat_reclamation'] ?></td>
                                <td><?= $data['subject'] ?></td>
                                <td><a href="modifier_reclamation.php?id_rec=<?= $id ?>"><button type="button"  class="btn btn-success">Modifier</button></a></td>
                                <td><a href="supprimer_reclamation.php?id_rec=<?= $id ?>"><button type="button"  class="btn btn-danger">Supprimer</button></a></td>
                            </tr>
                            <?php
                            }
                        }
