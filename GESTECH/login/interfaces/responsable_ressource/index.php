    ...
    <h2>Mes réclamations</h2>
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                <tbody>
                    <?php
                        $sql="SELECT * FROM reclamation r,etudiant e
                            WHERE r.matricule=e.matricule
                            AND etat_reclamation!='Bien traiter'";
                        ...
                        if($result){
                            ...
                            <tr>
                                <td><?= $data['nom'] ?></td>
                                <td><?= $data['prenom'] ?></td>
                                <td><?= $data['id_reclamation'] ?></td>
                                <td><?= $data['numero_chambre'] ?></td>
                                <td><?= $data['type'] ?></td>
                                <td><?= $data['etat_reclamation'] ?></td>
                                <td><?= $data['subject'] ?></td>
                                <td><a href="ajouterIntervention.php?id_rec=<?= $id ?>"><button type="button"  class="btn btn-success">Validé</button></a></td>
                            </tr>
                            <?php
                            }
                        }
